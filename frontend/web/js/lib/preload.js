...
function runDummy(){
	$('body').html('<div class="deprecated-box"> 	<div class="align db-align"> 		<span class="icon icon-window"><img src="/img/deprecated/window.png" alt="" /></span> 		<div class="db-text"><span class="bold">Ваш браузер устарел.</span> Сайт будет работать некорректно<div class="br"></div>  Чтобы исправить проблему, пожалуйста, обновите браузер <br /> на более позднюю версию или воспользуйтесь другим браузером.</div> 		<hr /> 		<a class="icon icon-browser-wrap"><span class="icon-text">Chrome</span><span class="icon"><img src="/img/deprecated/br_chrome" alt="" /></span></a> 	</div> </div>  <style type="text/css">  .deprecated-box, .deprecated-box *{ -webkit-box-sizing:content-box; -moz-box-sizing:content-box; box-sizing:content-box;}  .deprecated-box{ position:absolute; left:0; top:0; width:100%; height:100%; background:#00567d; font:18px/30px "pantonregular", Arial, sans-serif; color:#fff;}  .db-align{ text-align:center; width:600px; position:absolute; left:50%; top:50%; margin:-202px 0 0 -300px;}  .bold{ color:#dfe039; font-family: "pantonbold";}  .icon{ display:inline-block;}  .icon-window{ margin-bottom:30px;}  hr{ display:block; width:66px; height:2px; background:#e0e139; border-width:2px 0; border-style:solid; border-color:#69975d; margin:36px 0 48px;}  .icon-browser-wrap{ font:14px/20px "pantonregular"; text-decoration:none; color:#32c7fc;}  .icon-text{ display:inline-block;}  .icon-browser-wrap .icon-text{ display:block; margin-bottom:14px;}  .icon-browser-wrap:hover{ text-decoration:none; color:#fff;}  </style>            ');
}