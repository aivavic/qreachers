...
// Multiple Editor (for when `type` is an array)
    JSONEditor.defaults.editors.multiple = JSONEditor.AbstractEditor.extend({
        ...
        build: function () {
            ...
            browseButton.style.height = '31px';
            browseButton.appendChild(browseButtonText);
            ...
            $(browseButton).magnificPopup({
                ...
                items: [
                    {
                        src: html, // Dynamically created element
                        type: 'inline'
                    },
                ],
                callbacks: {
            ...
            this.switcher.style.height = '30px';
            this.switcher.style.display = 'inline-block';
            this.switcher.style.marginLeft = '20px';
