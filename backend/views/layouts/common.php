                ...
                'items'           => [
                    ...
                    [
                        ...
                        'items'   => [
                            ...
                            ['label' => Yii::t('backend', 'Projects'), 'url' => ['/project/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ...
                            ['label' => Yii::t('backend', 'Project Categories'), 'url' => ['/project-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
