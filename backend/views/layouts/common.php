            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                                    ...
                                    <?php foreach (\backend\models\SystemLog::find()->orderBy(['log_time' => SORT_DESC])->limit(5)->all() as $logEntry): ?>
                                        <li>
                                            <a href="<?php echo Yii::$app->urlManager->createUrl(['/log/view', 'id' => $logEntry->id]) ?>">
                                                ...
                                                echo $logEntry->level == \yii\log\Logger::LEVEL_ERROR
                                                        ? 'text-red' : 'text-yellow'
                                                ?>"></i>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php
                            echo Yii::$app->user->identity->userProfile->getAvatar() ?
                                    : '/img/anonymous.jpg'
                            ?>" class="user-image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php
                    echo Yii::$app->user->identity->userProfile->getAvatar() ? : '/img/anonymous.jpg'
                    ?>" class="img-circle" />
                </div>
                ...
                'items'           => [
                    ...
                    [
                        ...
                        'items'   => [
                            ...
                            ['label' => Yii::t('backend', 'Blog'), 'url' => ['/article/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ...
                            ['label' => Yii::t('backend', 'Menu social'), 'url' => ['widget-text/index?WidgetTextSearch%5Bid%5D=&WidgetTextSearch%5Bkey%5D=footer'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
